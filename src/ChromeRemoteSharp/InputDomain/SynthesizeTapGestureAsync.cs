...
namespace ChromeRemoteSharp.InputDomain
{
    public partial class InputDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Input#synthesizeTapGesture"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> SynthesizeTapGestureAsync(int x,int y,string duration,string tapCount,string gestureSourceType)
        {
