...
namespace ChromeRemoteSharp.InputDomain
{
    public partial class InputDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Input#dispatchTouchEvent"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> DispatchTouchEventAsync(string type,string[] touchPoints,string modifiers,string timestamp)
        {
