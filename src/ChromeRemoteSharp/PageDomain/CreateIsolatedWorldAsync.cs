...
namespace ChromeRemoteSharp.PageDomain
{
    public partial class PageDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Page#createIsolatedWorld"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> CreateIsolatedWorldAsync(string frameId,string worldName,bool? grantUniveralAccess)
        {
