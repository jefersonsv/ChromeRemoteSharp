...
namespace ChromeRemoteSharp.PageDomain
{
    public partial class PageDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Page#setTouchEmulationEnabled"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> SetTouchEmulationEnabledAsync(bool enabled,string configuration)
        {
