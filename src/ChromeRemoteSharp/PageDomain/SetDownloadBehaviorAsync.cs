...
namespace ChromeRemoteSharp.PageDomain
{
    public partial class PageDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Page#setDownloadBehavior"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> SetDownloadBehaviorAsync(string behavior,string downloadPath)
        {
