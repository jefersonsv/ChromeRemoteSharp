...
namespace ChromeRemoteSharp.PageDomain
{
    public partial class PageDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Page#captureScreenshot"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> CaptureScreenshotAsync(string format,string quality,string clip,bool? fromSurface)
        {
