...
namespace ChromeRemoteSharp.EmulationDomain
{
    public partial class EmulationDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Emulation#setTouchEmulationEnabled"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> SetTouchEmulationEnabledAsync(bool enabled,string maxTouchPoints)
        {
