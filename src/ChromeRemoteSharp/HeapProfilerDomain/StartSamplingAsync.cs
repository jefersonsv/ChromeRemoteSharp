...
namespace ChromeRemoteSharp.HeapProfilerDomain
{
    public partial class HeapProfilerDomain
    {
        /// <summary>
        /// 
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/HeapProfiler#startSampling"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> StartSamplingAsync(int? samplingInterval)
        {
