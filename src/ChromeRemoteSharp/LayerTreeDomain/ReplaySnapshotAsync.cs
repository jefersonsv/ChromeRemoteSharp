...
namespace ChromeRemoteSharp.LayerTreeDomain
{
    public partial class LayerTreeDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/LayerTree#replaySnapshot"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> ReplaySnapshotAsync(string snapshotId,string fromStep,string toStep,int? scale)
        {
