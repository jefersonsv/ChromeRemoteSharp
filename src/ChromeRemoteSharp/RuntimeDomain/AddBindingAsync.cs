...
namespace ChromeRemoteSharp.RuntimeDomain
{
    public partial class RuntimeDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Runtime#method-addBinding"/>
        /// </summary>
        /// <param name="name"></param>
        /// <param name="executionContextId"></param>
        /// <returns></returns>
        public async Task<JObject> AddBindingAsync(string name, string executionContextId = null)
        {
