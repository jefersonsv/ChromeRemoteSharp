...
namespace ChromeRemoteSharp.OverlayDomain
{
    public partial class OverlayDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Overlay#method-setInspectMode"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> SetInspectModeAsync(string mode, string highlightConfig = null)
        {
