...
namespace ChromeRemoteSharp.OverlayDomain
{
    public partial class OverlayDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Overlay#highlightNode"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> HighlightNodeAsync(string highlightConfig,string nodeId,string backendNodeId,string objectId)
        {
