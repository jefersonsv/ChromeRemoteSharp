...
namespace ChromeRemoteSharp.NetworkDomain
{
    public partial class NetworkDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Network#deleteCookies"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> DeleteCookiesAsync(string name,string url,string domain,string path)
        {
