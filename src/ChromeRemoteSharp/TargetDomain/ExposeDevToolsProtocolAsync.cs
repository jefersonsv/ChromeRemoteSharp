...
namespace ChromeRemoteSharp.TargetDomain
{
    public partial class TargetDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Target#exposeDevToolsProtocol"/>
        /// </summary>
        /// <param name="targetId"></param>
        /// <param name="bindingName">Binding name, 'cdp' if not specified.</param>
        /// <returns></returns>
        public async Task<JObject> ExposeDevToolsProtocolAsync(string targetId,string bindingName)
        {
