...
namespace ChromeRemoteSharp.HeadlessExperimentalDomain
{
    public partial class HeadlessExperimentalDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/HeadlessExperimental#method-beginFrame"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> BeginFrameAsync(int? frameTimeTicks = null, int? interval = null, bool? noDisplayUpdates = null, string screenshot = null)
        {
