...
namespace ChromeRemoteSharp.DomDomain
{
    public partial class DomDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/DOM#method-getDocument"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> GetDocumentAsync(string depth = null, bool? pierce = null)
        {
