...
namespace ChromeRemoteSharp.DomDomain
{
    public partial class DomDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Dom#requestChildNodes"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> RequestChildNodesAsync(string nodeId,string depth,bool? pierce)
        {
