...
namespace ChromeRemoteSharp.DomDomain
{
    public partial class DomDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Dom#setAttributeValue"/>
        /// </summary>
        /// <param name="nodeId">Id of the element to set attribute for.</param>
        /// <param name="name">Attribute name.</param>
        /// <param name="value">Attribute value.</param>
        /// <returns></returns>
        public async Task<JObject> SetAttributeValueAsync(string nodeId,string name,string value)
        {
