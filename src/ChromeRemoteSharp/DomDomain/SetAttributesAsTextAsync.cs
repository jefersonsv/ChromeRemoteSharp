...
namespace ChromeRemoteSharp.DomDomain
{
    public partial class DomDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Dom#setAttributesAsText"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> SetAttributesAsTextAsync(string nodeId,string text,string name)
        {
