...
namespace ChromeRemoteSharp.AuditsDomain
{
    public partial class AuditsDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Audits#getEncodedResponse"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> GetEncodedResponseAsync(string requestId,string encoding,int? quality,bool? sizeOnly)
        {
