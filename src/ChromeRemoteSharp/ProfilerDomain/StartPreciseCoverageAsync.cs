...
namespace ChromeRemoteSharp.ProfilerDomain
{
    public partial class ProfilerDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Profiler#startPreciseCoverage"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> StartPreciseCoverageAsync(bool? callCount,bool? detailed)
        {
