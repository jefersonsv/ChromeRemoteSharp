...
namespace ChromeRemoteSharp.DebuggerDomain
{
    public partial class DebuggerDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Debugger#method-getPossibleBreakpoints"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> GetPossibleBreakpointsAsync(string start, string end = null, bool? restrictToFunction = null)
        {
