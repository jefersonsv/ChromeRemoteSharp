...
namespace ChromeRemoteSharp.DebuggerDomain
{
    public partial class DebuggerDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/Debugger#setScriptSource"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> SetScriptSourceAsync(string scriptId,string scriptSource,bool? dryRun)
        {
