...
namespace ChromeRemoteSharp.DomSnapshotDomain
{
    public partial class DomSnapshotDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/DomSnapshot#getSnapshot"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> GetSnapshotAsync(string[] computedStyleWhitelist,bool? includeEventListeners,bool? includePaintOrder,bool? includeUserAgentShadowTree)
        {
