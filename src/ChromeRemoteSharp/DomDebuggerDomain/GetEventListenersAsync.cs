...
namespace ChromeRemoteSharp.DomDebuggerDomain
{
    public partial class DomDebuggerDomain
    {
        ...
        /// <see cref="https://chromedevtools.github.io/devtools-protocol/tot/DomDebugger#getEventListeners"/>
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<JObject> GetEventListenersAsync(string objectId,string depth,bool? pierce)
        {
